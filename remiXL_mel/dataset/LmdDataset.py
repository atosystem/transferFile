...
class LmdDataset(torch.utils.data.dataset.Dataset):
    def __init__(self,data_path,midiDIR,partition="train",max_length=1024,grp_size = 13):
        ...
        self.pkl_files: list = [ os.path.join(midiDIR,"{}_full.pkl".format(x) ) for x in songs_dict[partition]]
    ...
    def __getitem__(self, idx):
        ...
        att_msk, _seq = self.padding(_seq,total_length=self.grp_size*self.max_length+1)
