...
def main():
    ...
    if checkpoint_type == 'best_train':
        ...
        # model_path = "/home/atosystem/nas_disk/projects/multitrack/remi-xl_remiMulti/exp/final_head10_layer12_emb1024_q256/ep_6_step_10230.pth.tar"
        model_path = "/home/atosystem/nas_disk/projects/multitrack/codeWordTrans/xl/ckpts/initialTry_cont_1/ep_59_step_340007.pth.tar"
    ...
    # load dictionary
    event2word, word2event = myvocab.token2id, myvocab.id2token
    ...
    for idx in range(num_samples):
        ...
        song_time, word_len = model.inference(
            ...
            params={'t': 1.2, 'p': 0.9},
            bpm=120,
            output_path='{}/{}.pkl'.format(midi_folder, output_prefix + str(idx)))
